...
function load_assets(){
    ...
    // wp_add_inline_script("university_scripts", 'new DataTable("#example")', 'after');
    wp_enqueue_script("dataTableJS", get_theme_file_uri() . '/build/dataTable.js', array('jquery'), '1.01', true);
    wp_enqueue_script("custom_js", get_theme_file_uri() . '/build/custom.js', array('jquery'), '1.01', true);
