...
function load_assets(){
    ...
    wp_enqueue_style( "dataTableCss", get_theme_file_uri() . '/css/dataTables.dataTables.css', array(), '1.0.0', 'all' );

    wp_enqueue_script("dataTables_scripts", get_theme_file_uri() . '/js/dataTables.js', array('jquery'), '1.0.0', true);
